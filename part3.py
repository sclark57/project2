...
if __name__ == "__main__":
	...
	df_train = spark.read.load('../input/adult_train.csv', format='com.databricks.spark.csv', header='false', inferSchema='true').cache()
	
	df_test = spark.read.load('../input/adult_test.csv', format='com.databricks.spark.csv', header='false', inferSchema='true').cache()
